...
namespace MDIInventarioyFacturación.Forms.MovInventario
{
    public partial class NuevoMovimiento : Form
    {
        ...
        private void btnSelectTipo_Click(object sender, EventArgs e)
        {
            FormTiposDeMovimiento selecType = new FormTiposDeMovimiento();
            selecType.ShowDialog();
            // we have to fill the data with the data that he select
        ...
        private void txtConsultaBodega_Click_1(object sender, EventArgs e)
        {
        ...
        private void dtMovimiento_ValueChanged_1(object sender, EventArgs e)
        {
            txtFechaMovimiento.Text = dtMovimiento.Value.ToString("yyy/MM/dd");
        }
